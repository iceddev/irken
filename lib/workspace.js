...
/**
 * Creates a new immutable data structure with api to manage state and user interactions.
 * @property {Cursor} filename a name associated with current content.
 * @property {Cursor} current content currently displayed.
 * @property {Cursor} directory the path to where the current file resides.
 */
function Workspace(){
  var self = this;
...
/**
 * Read file from filepath and load as current.
 * @param  {string}
 * @param  {Function}
 * @return {undefined}
 */
...
/**
 * The kingping function of the workspace object.  Changes to filepath if exists or creates a new directory at filepath and changes to it.
 * @param  {string}
 * @param  {Function}
 * @return {undefined}
 */
